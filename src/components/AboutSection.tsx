...
const AboutSection = () => {
  ...
  return (
    <section id="chi-siamo" ref={sectionRef} className="relative py-20 md:py-40 px-4 md:px-16 overflow-hidden">
      <div
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        >
          <p
            className="text-xs md:text-[14px] leading-[2]"
            style={{ fontFamily: 'var(--font-body)', fontWeight: 300, color: 'rgba(220,218,214,0.65)' }}
          >
